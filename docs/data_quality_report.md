...
_Generated: 2026-07-27 14:59:40_
...
- **appointments.dtype_mismatch** — all columns match expected type ✅
...
- **patients.dtype_mismatch** — all columns match expected type ✅
...
- **treatments.dtype_mismatch** — all columns match expected type ✅
